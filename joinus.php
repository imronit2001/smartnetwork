  ...
  if ($row_checkAlrExist > 0) {
    ...
    if ($pwd == $cpwd) {
      ...
      $uid = $row['id'];
        ...
        // Changing the wallets from level 1 to 10
        // for ($i = $level-1; $i >= 1; $i--) {
        //   // Setting the increment value of wallet
        //   if($i==1){
        //     $inc = 30;
        //   }elseif($i==2){
        //     $inc = 15;
        ...
        //   // Updating the wallet of 1st parents according to their level
        //   // Here ref_code is the my_ref_code of parents
        ...
        //   // Getting ref_code of 1st parents i.e my_ref_code of 2nd parent
